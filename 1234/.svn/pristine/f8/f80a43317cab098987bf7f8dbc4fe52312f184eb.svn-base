...
public class AlertUtil {
 ...
 private static boolean state;
   ...
   public static void showAlertOnlyConfirm(Stage baseStage,String cotent1,String button1) {
		try {
	       	FXMLLoader loader = new FXMLLoader(AlertUtil.class.getResource("AlertOnlyConfirm.fxml"));
	   		Parent root = loader.load();
	   		Scene scene = new Scene(root);
	   		Stage dialog = new Stage();
	   		dialog.initModality(Modality.WINDOW_MODAL);
	   		...
	   		AlertOnlyConfirmController test = loader.getController();
	   		test.alertMessageSet(cotent1);
	   		test.alertButtonSet(button1);
