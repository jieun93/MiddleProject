...
public class AddSearch {
	...
	private static MemberController dialog;
	
	 
    public MemberController getDialog() {
		return dialog;
	}

	public void setDialog(MemberController dialog) {
		this.dialog = dialog;
	}
    ...
    void listview(MouseEvent event) throws IOException {
    	// 화면전환
    	FXMLLoader loader = new FXMLLoader(AddSearch.class.getResource("../../fxml/member/AddSearch2.fxml"));
