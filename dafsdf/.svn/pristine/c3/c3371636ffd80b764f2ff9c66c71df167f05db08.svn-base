...
public class AdminMainController {
    ...
    void btnInsertClick(ActionEvent event) throws IOException {
    	...
    	FXMLLoader loader = new FXMLLoader(AdminMainController.class.getResource("../../fxml/stuff/fxmlInsert.fxml"));
    	Parent root = loader.load();
    ...
    void tableClick(MouseEvent event) throws IOException {
    	...
    	FXMLLoader loader = new FXMLLoader(AdminMainController.class.getResource("../../fxml/stuff/fxmlUpdateAndDelete.fxml"));
    	Parent root = loader.load();
