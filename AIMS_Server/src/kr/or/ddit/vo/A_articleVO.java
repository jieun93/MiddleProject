...
public class A_articleVO implements Serializable{
	/**
	 * 
	 */
//	private static final long serialVersionUID = -2216707613216502049L;
	...
	private String a_art_price;
	private String a_art_addnum;
	private String a_art_detailadd;
	...
	public String getA_art_price() {
		return a_art_price;
	}
	public void setA_art_price(String a_art_price) {
		this.a_art_price = a_art_price;
	}
	public String getA_art_addnum() {
		return a_art_addnum;
	}
	public void setA_art_addnum(String a_art_addnum) {
		this.a_art_addnum = a_art_addnum;
	}
	public String getA_art_detailadd() {
		return a_art_detailadd;
	}
	public void setA_art_detailadd(String a_art_detailadd) {
		this.a_art_detailadd = a_art_detailadd;
	}
