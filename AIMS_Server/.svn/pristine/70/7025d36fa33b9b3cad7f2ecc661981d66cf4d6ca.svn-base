...
public interface InoticeDAO extends Remote{
	
	public int getNoticTotalCount()throws RemoteException; //공지사항 총 수
	public int getQuestionTotalcount()throws RemoteException;
	public List<NoticeVO> getPaginNoticeList(Map<String,Integer> pageMap)throws RemoteException;// pagein처리
	...
	public List<Notice_FileVO> getNoticeFileList(String notice_no)throws RemoteException;//공지에 해당하는 파일가져오기
	public List<Answer_FileVO> getAnswerFileList(String com_ans_no)throws RemoteException;//민원질문에 해당하는 파일가져오기
	public List<Question_FileVO> getQuestionFileList(String com_que_no)throws RemoteException;//민원답변에 해당하는 파일가져오기
