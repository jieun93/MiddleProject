...
public interface ISearchDao {
	 ...
	 */
	public List<A_articleVO> numSearch(String a_art_no); // 물건번호 검색
	 ...
	 * @return 검색결과를 List에 넣어서 반환한다.
	 */
	public List<A_articleVO> courtSearch(String cou_no); // 법원 이름으로 검색******************************/////////////////////////////////////////////////////////////////////////
	 ...
	 */
	public List<A_articleVO> dateSearch(Map<String, String> a_art_day); // 기간으로 검색
	 ...
	 * @return 검색 결과를 List에 담아서 반환한다.
	 */
	public List<A_articleVO> categoryASearch(Map<String, String> cat_a_no); // 카테고리 검색
	 ...
	 * @return 검색 결과를 List에 담아서 반환한다.
	 */
	public List<A_articleVO> priceSearch(Map<String, String> a_art_price); // 감정평가액으로 검색
	 ...
	 * @return 검색 결과를 List에 담아서 반환한다.
	 */
	public List<A_articleVO> lowSearch(); // 최저 매각액
	 ...
	 * @return 검색 결과를 List에 담아서 반환한다.
	 */
	public List<A_articleVO> areaSearch(Map<String, String> a_art_area); // 면적으로 검색
	 ...
	 * @return 검색 결과를 List에 담아서 반환한다.
	 */
	public List<A_articleVO> tourSearch(); // 유찰횟수 검색
	/**
	 * 관심도를 매개변수로 받아 해당 물건을 반환하는 메서드
	 * @param a_art_inter
	 * @return 검색 결과를 List에 담아서 반환한다.
	 */
	public List<A_articleVO> interSearch(); // 다수관심도 검색
	/**
	 * 조회수를 매개변수로 받아 해당 물건을 반환하는 메서드
	 * @param a_art_cnt
	 * @return 검색 결과를 List에 담아서 반환한다.
	 */
	public List<A_articleVO> cntSearch(); // 조회수 검색
	 ...
	 * @return
	 */
	public List<A_articleVO> resultSearch(String a_art_result); // 경매결과 검색
